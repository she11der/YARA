rule SIGNATURE_BASE_Trojan_ISMRAT_Gen___FILE
{
	meta:
		description = "ISM RAT"
		author = "Ahmed Zaki"
		...
		source_url = "https://github.com/Neo23x0/signature-base/blob/1985dee16d61c60c9970e213ad2ef57039eaa1d5/yara/apt_ism_rat.yar#L9-L25"
