rule CHECK_POINT_Apt_Nazar_Component_Guids
{
	meta:
		...
		source_url = "https://github.com/mikesxrs/Open-Source-YARA-rules/blob/39f33a829cb887d6ecf96c63cc98f312c82eeefd/Checkpoint/apt_nazar_component_guids.yar#L1-L32"
		license_url = "N/A"
