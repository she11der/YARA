rule FIREEYE_RT_APT_Hacktool_MSIL_FLUFFY_2___FILE
{
	meta:
		...
		source_url = "https://github.com/mandiant/red_team_tool_countermeasures//blob/abcba6e9291a04ec1093ce3a4b0b258c1eb891ef/rules/FLUFFY/production/yara/APT_HackTool_MSIL_FLUFFY_2.yar#L4-L21"
