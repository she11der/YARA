rule COD3NYM_MAL_NET_Limecrypter_Runpe_Jan24___FILE
{
	meta:
		...
		source_url = "https://github.com/cod3nym/detection-rules//blob/303e761a5ea3cdee922431cfb1d6cadbee6f8a3a/yara/dotnet/mal/mal_net_limecrypter_runpe.yar#L1-L22"
