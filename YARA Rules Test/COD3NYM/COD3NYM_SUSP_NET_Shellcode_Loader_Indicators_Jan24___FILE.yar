rule COD3NYM_SUSP_NET_Shellcode_Loader_Indicators_Jan24___FILE
{
	meta:
		...
		source_url = "https://github.com/cod3nym/detection-rules//blob/303e761a5ea3cdee922431cfb1d6cadbee6f8a3a/yara/dotnet/suspicious_indicators.yar#L1-L22"
