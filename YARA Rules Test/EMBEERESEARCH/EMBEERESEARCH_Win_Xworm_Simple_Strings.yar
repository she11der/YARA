rule EMBEERESEARCH_Win_Xworm_Simple_Strings
{
	meta:
		...
		source_url = "https://github.com/embee-research/Yara-detection-rules//blob/d4226e586a49cd4d1eede9a58738509689cf059f/Rules/win_xworm_simple_strings_sep_2023.yar#L3-L29"
		license_url = "N/A"
