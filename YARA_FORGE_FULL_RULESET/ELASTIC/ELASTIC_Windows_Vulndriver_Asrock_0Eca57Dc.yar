rule ELASTIC_Windows_Vulndriver_Asrock_0Eca57Dc : FILE
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/Windows_VulnDriver_Asrock.yar#L41-L62"
