rule ELASTIC_Macos_Cryptominer_Generic_D3F68E29 : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/MacOS_Cryptominer_Generic.yar#L1-L21"
