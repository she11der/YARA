rule ELASTIC_Macos_Backdoor_Useragent_1A02Fc3A : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/MacOS_Backdoor_Useragent.yar#L1-L23"
