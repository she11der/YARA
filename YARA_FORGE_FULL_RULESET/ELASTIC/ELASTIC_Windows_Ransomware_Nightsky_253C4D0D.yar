rule ELASTIC_Windows_Ransomware_Nightsky_253C4D0D : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/Windows_Ransomware_Nightsky.yar#L24-L42"
