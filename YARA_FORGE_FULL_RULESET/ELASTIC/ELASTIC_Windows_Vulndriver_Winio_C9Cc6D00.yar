rule ELASTIC_Windows_Vulndriver_Winio_C9Cc6D00 : FILE
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/Windows_VulnDriver_WinIo.yar#L1-L19"
