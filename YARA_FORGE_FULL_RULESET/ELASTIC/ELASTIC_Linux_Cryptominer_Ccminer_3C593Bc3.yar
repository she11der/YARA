rule ELASTIC_Linux_Cryptominer_Ccminer_3C593Bc3 : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/Linux_Cryptominer_Ccminer.yar#L21-L39"
