rule ELASTIC_Windows_Hacktool_Sharpstay_Eac706C5 : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/Windows_Hacktool_SharpStay.yar#L1-L23"
