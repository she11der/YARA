rule ELASTIC_Macos_Trojan_Thiefquest_40F9C1C3 : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/MacOS_Trojan_Thiefquest.yar#L64-L82"
