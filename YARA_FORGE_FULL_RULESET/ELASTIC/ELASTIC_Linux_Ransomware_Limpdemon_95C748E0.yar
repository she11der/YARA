rule ELASTIC_Linux_Ransomware_Limpdemon_95C748E0 : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/Linux_Ransomware_LimpDemon.yar#L1-L22"
