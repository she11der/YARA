rule ELASTIC_Windows_Trojan_Flawedgrace_8C5Eb04B : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/Windows_Trojan_FlawedGrace.yar#L1-L23"
