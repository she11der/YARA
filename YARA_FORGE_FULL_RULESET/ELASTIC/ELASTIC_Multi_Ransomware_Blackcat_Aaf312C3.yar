rule ELASTIC_Multi_Ransomware_Blackcat_Aaf312C3 : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/Multi_Ransomware_BlackCat.yar#L1-L20"
