rule ELASTIC_Macos_Virus_Maxofferdeal_53Df500F : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/MacOS_Virus_Maxofferdeal.yar#L1-L19"
