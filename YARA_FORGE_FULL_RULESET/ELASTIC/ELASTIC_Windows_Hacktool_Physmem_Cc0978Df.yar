rule ELASTIC_Windows_Hacktool_Physmem_Cc0978Df : FILE
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/Windows_Hacktool_PhysMem.yar#L1-L20"
