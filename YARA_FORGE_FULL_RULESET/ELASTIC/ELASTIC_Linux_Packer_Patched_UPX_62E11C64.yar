rule ELASTIC_Linux_Packer_Patched_UPX_62E11C64 : FILE
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/Linux_Packer_Patched_UPX.yar#L1-L20"
