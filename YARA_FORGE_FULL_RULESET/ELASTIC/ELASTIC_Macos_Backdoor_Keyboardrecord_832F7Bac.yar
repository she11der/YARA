rule ELASTIC_Macos_Backdoor_Keyboardrecord_832F7Bac : FILE
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/MacOS_Backdoor_Keyboardrecord.yar#L1-L23"
