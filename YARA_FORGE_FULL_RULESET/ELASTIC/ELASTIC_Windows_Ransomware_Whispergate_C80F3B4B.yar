rule ELASTIC_Windows_Ransomware_Whispergate_C80F3B4B : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/Windows_Ransomware_WhisperGate.yar#L1-L20"
