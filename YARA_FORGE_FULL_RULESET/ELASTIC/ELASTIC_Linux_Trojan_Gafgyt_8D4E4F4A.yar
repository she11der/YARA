rule ELASTIC_Linux_Trojan_Gafgyt_8D4E4F4A : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/Linux_Trojan_Gafgyt.yar#L1447-L1465"
