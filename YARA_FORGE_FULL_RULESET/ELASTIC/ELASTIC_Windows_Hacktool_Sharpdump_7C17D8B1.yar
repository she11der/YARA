rule ELASTIC_Windows_Hacktool_Sharpdump_7C17D8B1 : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/Windows_Hacktool_SharpDump.yar#L1-L23"
