rule ELASTIC_Macos_Trojan_Bundlore_753E5738 : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/MacOS_Trojan_Bundlore.yar#L181-L199"
