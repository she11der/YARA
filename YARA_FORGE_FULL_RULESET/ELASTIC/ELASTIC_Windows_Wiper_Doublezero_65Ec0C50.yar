rule ELASTIC_Windows_Wiper_Doublezero_65Ec0C50 : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/Windows_Wiper_DoubleZero.yar#L1-L23"
