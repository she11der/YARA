rule ELASTIC_Windows_Trojan_Suddenicon_8B07C275 : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/Windows_Trojan_SuddenIcon.yar#L28-L48"
