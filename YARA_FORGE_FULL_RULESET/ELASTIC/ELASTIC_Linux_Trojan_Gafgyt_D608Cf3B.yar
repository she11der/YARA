rule ELASTIC_Linux_Trojan_Gafgyt_D608Cf3B : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/Linux_Trojan_Gafgyt.yar#L1267-L1285"
