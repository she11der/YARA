rule ELASTIC_Linux_Ransomware_Echoraix_Ea9532Df : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/6d54ae289b290b1d42a7717569483f6ce907200a/yara/rules/Linux_Ransomware_EchoRaix.yar#L1-L19"
