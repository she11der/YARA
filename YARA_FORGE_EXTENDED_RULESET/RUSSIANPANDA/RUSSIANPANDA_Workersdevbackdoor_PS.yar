rule RUSSIANPANDA_Workersdevbackdoor_PS : FILE
{
	meta:
		...
		source_url = "https://github.com/RussianPanda95/Yara-Rules/blob/d6b1e8ac1e4cbf548804bd84e5f63f3f426b9738/WorkersDevBackdoor/WorkersDevBackdoor_PS.yar#L1-L18"
		license_url = "N/A"
