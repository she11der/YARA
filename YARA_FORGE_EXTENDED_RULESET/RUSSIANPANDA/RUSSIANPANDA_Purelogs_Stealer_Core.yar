...
rule RUSSIANPANDA_Purelogs_Stealer_Core : FILE
{
	meta:
		...
		source_url = "https://github.com/RussianPanda95/Yara-Rules/blob/d6b1e8ac1e4cbf548804bd84e5f63f3f426b9738/Pure Logs Stealer/purelogs_stealer_core.yar#L3-L18"
		license_url = "N/A"
