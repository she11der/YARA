rule RUSSIANPANDA_Win_Sus_Internetshortcutfile
{
	meta:
		...
		source_url = "https://github.com/RussianPanda95/Yara-Rules/blob/d6b1e8ac1e4cbf548804bd84e5f63f3f426b9738/Techniques/win_sus_InternetShortcutFile.yar#L1-L19"
		license_url = "N/A"
