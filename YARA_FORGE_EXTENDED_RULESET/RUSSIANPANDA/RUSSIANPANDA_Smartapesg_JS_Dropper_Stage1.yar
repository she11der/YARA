rule RUSSIANPANDA_Smartapesg_JS_Dropper_Stage1 : FILE
{
	meta:
		...
		source_url = "https://github.com/RussianPanda95/Yara-Rules/blob/d6b1e8ac1e4cbf548804bd84e5f63f3f426b9738/SmartApeSG/SmartApeSG_JS_dropper_stage1.yar#L1-L18"
		license_url = "N/A"
