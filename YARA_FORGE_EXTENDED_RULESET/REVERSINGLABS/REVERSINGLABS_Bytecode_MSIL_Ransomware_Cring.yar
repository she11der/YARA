rule REVERSINGLABS_Bytecode_MSIL_Ransomware_Cring : tc_detection malicious MALWARE FILE
{
	meta:
		...
		source_url = "https://github.com/reversinglabs/reversinglabs-yara-rules//blob/6db04d21a54cece1e65f12769dd0dd24d44def78/yara/ransomware/ByteCode.MSIL.Ransomware.Cring.yara#L1-L66"
