rule ELASTIC_Windows_Trojan_Redlinestealer_3D9371Fd : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/84213d9b40fee553ea3065cb4bb057c7c1685b59/yara/rules/Windows_Trojan_RedLineStealer.yar#L78-L102"
