rule ELASTIC_Windows_Trojan_Fickerstealer_F2159Bec : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/84213d9b40fee553ea3065cb4bb057c7c1685b59/yara/rules/Windows_Trojan_Fickerstealer.yar#L22-L40"
