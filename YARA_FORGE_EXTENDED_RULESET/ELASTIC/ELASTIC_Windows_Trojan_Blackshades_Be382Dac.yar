rule ELASTIC_Windows_Trojan_Blackshades_Be382Dac : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/84213d9b40fee553ea3065cb4bb057c7c1685b59/yara/rules/Windows_Trojan_BlackShades.yar#L28-L46"
