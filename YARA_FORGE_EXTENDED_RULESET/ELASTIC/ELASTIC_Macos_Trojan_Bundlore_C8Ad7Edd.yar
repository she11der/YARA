rule ELASTIC_Macos_Trojan_Bundlore_C8Ad7Edd : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/84213d9b40fee553ea3065cb4bb057c7c1685b59/yara/rules/MacOS_Trojan_Bundlore.yar#L141-L159"
