rule ELASTIC_Windows_Trojan_Revcoderat_8E6D4182 : FILE MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/84213d9b40fee553ea3065cb4bb057c7c1685b59/yara/rules/Windows_Trojan_Revcoderat.yar#L1-L22"
