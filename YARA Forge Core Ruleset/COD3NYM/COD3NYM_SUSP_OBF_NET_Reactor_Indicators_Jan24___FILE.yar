rule COD3NYM_SUSP_OBF_NET_Reactor_Indicators_Jan24___FILE
{
	meta:
		...
		source_url = "https://github.com/cod3nym/detection-rules//blob/303e761a5ea3cdee922431cfb1d6cadbee6f8a3a/yara/dotnet/obf_net_reactor.yar#L18-L34"
