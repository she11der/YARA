rule ELASTIC_Windows_Trojan_Revcoderat_8E6D4182___FILE_MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/8b6b3b3977b462ae1c68ae8756c095b6bcba2da6/yara/rules/Windows_Trojan_Revcoderat.yar#L1-L22"
