rule ELASTIC_Linux_Trojan_Gafgyt_A0A4De11___FILE_MEMORY
{
	meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/8b6b3b3977b462ae1c68ae8756c095b6bcba2da6/yara/rules/Linux_Trojan_Gafgyt.yar#L415-L433"
