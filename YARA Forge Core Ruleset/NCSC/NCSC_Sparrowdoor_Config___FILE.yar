rule NCSC_Sparrowdoor_Config___FILE
{
	meta:
		...
		source_url = "https://github.com/mikesxrs/Open-Source-YARA-rules/blob/39f33a829cb887d6ecf96c63cc98f312c82eeefd/NCSC/SparrowDoor_config.yar#L1-L14"
		license_url = "N/A"
