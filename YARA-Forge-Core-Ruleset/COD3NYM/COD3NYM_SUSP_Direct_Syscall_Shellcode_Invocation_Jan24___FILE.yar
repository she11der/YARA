rule COD3NYM_SUSP_Direct_Syscall_Shellcode_Invocation_Jan24___FILE
{
	meta:
		...
		source_url = "https://github.com/cod3nym/detection-rules//blob/303e761a5ea3cdee922431cfb1d6cadbee6f8a3a/yara/other/susp_direct_syscall_shellcode_invocation.yar#L1-L14"
