rule EMBEERESEARCH_Win_Lumma_Simple_Strings___FILE
{
	meta:
		description = ""
		...
		source_url = "https://github.com/embee-research/Yara-detection-rules//blob/d4226e586a49cd4d1eede9a58738509689cf059f/Rules/win_lumma _simple_sep_2023.yar#L1-L40"
		license_url = "N/A"
