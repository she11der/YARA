rule FIREEYE_RT_Trojan_Win_Generic_101___FILE
{
	meta:
		...
		source_url = "https://github.com/mandiant/red_team_tool_countermeasures//blob/abcba6e9291a04ec1093ce3a4b0b258c1eb891ef/rules/BEACON/supplemental/yara/Trojan_Win_Generic_101.yar#L4-L20"
